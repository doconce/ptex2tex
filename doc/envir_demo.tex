...
\noindent
Here is a demo of the environment \code{ANS_t_Python}:
\bn8
# Here is some Python code
...
\noindent
Here is a demo of the environment \code{ANS_Python}:
\bn9
# Here is some Python code
...
\noindent
Here is a demo of the environment \code{ANS_t_Cpp}:
\bn10
# Here is some C++ code
...
\noindent
Here is a demo of the environment \code{ANS_Cpp}:
\bn11
# Here is some C++ code
...
\noindent
Here is a demo of the environment \code{ANS_Matlab}:
\bn12
...
\noindent
Here is a demo of the environment \code{ANS_t_Bash}:
\bn13
#!/bin/bash
files=$@
...
\noindent
Here is a demo of the environment \code{ANS_Bash}:
\bn14
#!/bin/bash
files=$@
...
\noindent
Here is a demo of the environment \code{ANS_t_Swig}:
\bn15
/* file: hw.i */
%module hw
%{
...
\noindent
Here is a demo of the environment \code{ANS_Swig}:
\bn16
/* file: hw.i */
%module hw
%{
...
\noindent
Here is a demo of the environment \code{ANS_t_gencode}:
\bn17
...
\noindent
Here is a demo of the environment \code{ANS_gencode}:
\bn18
static PyObject *_wrap_hw1(PyObject *self, PyObject *args) {
    double arg1, arg2, result;
...
\noindent
Here is a demo of the environment \code{ANS_t_UFL}:
\bn19
...
\noindent
Here is a demo of the environment \code{ANS_UFL}:
\bn20
V = FunctionSpace(mesh, 'Lagrange', 3)
u = TrialFunction(V)
v = TestFunction(V)
...
\noindent
Here is a demo of the environment \code{ANS_t_Output}:
\bn21
...
\noindent
Here is a demo of the environment \code{ANS_Output}:
\bn22
i= 1:  0.916752431  1.234526111
i= 2:  2.128967564  2.098176522
i= 3:  4.987856451  0.121212220
...
\noindent
Here is a demo of the environment \code{tiny_Minted_Python}:
\bn24
# Here is some Python code
